...
![print fluxo excalidraw](./images/fluxoagenteexcalidraw.png)
![print fluxo 1](./images/fluxoagente1.png)
![print fluxo 2 metadata](./images/fluxoagente2.png)

>## Passos
>Para a execução do objetivo foram seguidos os seguintes **passos**:
## Passo 1
Fork do Challenge no Github
![print do fork](./images/print%20fork.png)

## Passo 2
Criação da conta da Azure, na localização "Canada East"
![print conta azure](./images/contaazure.png)

## Passo 3
Criação do grupo de recursos 
![print resource group](./images/resourcegroup.png)

## Passo 4
Criação do AI Foundry
![print ai foundry](./images/aifoundry.png)
...
![print pay-as-you-go](./images/pay-as-you-go.png)

## Passo 6
Implantação do modelo, utilizando o gpt4.1, na localização "Canada East"
![print gpt4.1](./images/modelogpt4.1.png)
...
![print criacao agente](./images/printagente.png)
...
![print acao agente](./images/testeacao.png)
![print acao email](./images/baymaxemail.png)
...
![print teste conhecimento](./images/testeconhecimento.png)
![print e-mail conhecimento](./images/provatestebaymax.png)
...
![print tempo acao](./images/tempo-acao.png)
...
![print teste tempo](./images/print%20teste%20tempo.png)
![print email tempo](./images/email%20tempo.png)
...
[![video agente challenge](./images/print-video.png)](https://youtu.be/6G2CTT74gDA)
